...
$footer_column = $shoppingcart_settings['shoppingcart_footer_column_section'];
	...
	if ( is_active_sidebar( 'shoppingcart_footer_options' ) ) :
		...
		<a title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" target="_blank" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo get_bloginfo( 'name', 'display' ); ?></a> | 
						<?php esc_html_e('Designed by:','shoppingcart'); ?> <a title="<?php echo esc_attr__( 'Owen Murithi', 'shoppingcart' ); ?>" target="_blank" href="<?php echo esc_url( '#' ); ?>"><?php esc_html_e('Owen Murithi','shoppingcart');?></a> |
						<?php  echo '&copy; ' . date_i18n(__('Y','shoppingcart')) ; ?> <a title="<?php echo esc_attr__( 'Owen Murithi', 'shoppingcart' );?>" target="_blank" href="<?php echo esc_url( '#' );?>"><?php esc_html_e('Owen Murithi','shoppingcart'); ?></a>
					</div>
	<?php endif; ?>
